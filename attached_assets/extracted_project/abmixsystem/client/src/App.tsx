    ...
    <ThemeProvider>
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              <div className="hidden md:flex items-center space-x-6">
                <a href="#" className="text-gray-600 dark:text-gray-300 hover:text-gray-800 dark:hover:text-white font-bold transition-colors">Sobre</a>
                <a href="#" className="text-gray-600 dark:text-gray-300 hover:text-gray-800 dark:hover:text-white font-bold transition-colors">Contato</a>
                <a href="#" className="text-gray-600 dark:text-gray-300 hover:text-gray-800 dark:hover:text-white font-bold transition-colors">Suporte</a>
              </div>
              <MobileRefreshButton />
              <ThemeToggle />
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative z-10">
        ...
        <div className="text-center mb-20 relative">
          ...
          <h1 className="text-5xl md:text-6xl font-bold text-gray-600 dark:text-gray-300 mb-6 leading-tight transition-colors duration-300">
            Sistema Abmix de Propostas
          </h1>
          <p className="text-xl text-gray-600 dark:text-gray-300 font-bold max-w-4xl mx-auto leading-relaxed relative z-10 transition-colors duration-300">
          ...
          <div className="flex items-center justify-center space-x-8 mt-8 relative z-10">
            <div className="flex items-center text-gray-600 dark:text-gray-300 font-bold transition-colors duration-300">
        ...
        <div className={`grid grid-cols-1 md:grid-cols-2 ${showClientPortal ? 'lg:grid-cols-5' : 'lg:grid-cols-4'} gap-8 mb-16 px-4`}>
          ...
          {showClientPortal && (
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed font-medium transition-colors duration-300">
        ...
        {/* Features Section */}
        <div className="bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-3xl p-12 mb-16 border border-gray-200 dark:border-gray-700 transition-colors duration-300">
          <div className="text-center mb-12">
            <p className="text-gray-600 dark:text-gray-300 text-lg font-medium transition-colors duration-300">Tecnologia de ponta para simplificar seus processos</p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="w-16 h-16 bg-gray-100 dark:bg-gray-700 border-2 border-blue-500 rounded-2xl flex items-center justify-center mx-auto mb-4 transition-colors duration-300">
                <Database className="w-8 h-8 text-gray-600 dark:text-gray-300" />
              </div>
              <h3 className="text-xl font-bold text-gray-700 dark:text-gray-300 mb-2 transition-colors duration-300">Gestão Centralizada</h3>
              <p className="text-gray-600 dark:text-gray-300 font-medium transition-colors duration-300">Sistema integrado para controle total de propostas e documentos</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-700 dark:text-gray-300 mb-2 transition-colors duration-300">Eficiência Operacional</h3>
              <p className="text-gray-600 dark:text-gray-300 font-medium transition-colors duration-300">Automação inteligente reduzindo tempo de processamento</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-700 dark:text-gray-300 mb-2 transition-colors duration-300">Excelência Corporativa</h3>
              <p className="text-gray-600 dark:text-gray-300 font-medium transition-colors duration-300">Padrões empresariais com conformidade e segurança</p>
            </div>
          </div>
        </div>
      ...
      {/* Footer */}
      <footer className="bg-gray-100 dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 py-4 px-6 transition-colors duration-300">
          ...
          <div className="flex items-center justify-between text-xs text-gray-600 dark:text-gray-300 transition-colors duration-300">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="flex flex-col space-y-1">
                <span className="font-medium text-gray-700 dark:text-gray-300 transition-colors duration-300">Sistema Interno v2.0</span>
                <span className="text-gray-500 dark:text-gray-400 transition-colors duration-300">© 2025 Abmix Consultoria</span>
              </div>
            </div>
