  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm dark:shadow-gray-900/30 border border-gray-100 dark:border-gray-600 p-6">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Visão Geral das Integrações</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="border border-gray-200 dark:border-gray-600 rounded-lg p-4">
            <div className="flex items-center mb-3">
              ...
              <h3 className="ml-3 text-lg font-medium text-gray-900 dark:text-white">Google Sheets</h3>
            </div>
          ...
          <div className="border border-gray-200 dark:border-gray-600 rounded-lg p-4">
            <div className="flex items-center mb-3">
              ...
              <h3 className="ml-3 text-lg font-medium text-gray-900 dark:text-white">Make</h3>
            </div>
            <p className="text-sm text-gray-600 dark:text-gray-300">
      ...
      {/* Google Sheets */}
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm dark:shadow-gray-900/30 border border-gray-100 dark:border-gray-600 p-6">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Integração com Google Sheets</h2>
          ...
          <div className="space-y-4">
            <div className="flex">
              <div className="flex-shrink-0 w-8 h-8 bg-teal-100 dark:bg-teal-900 rounded-full flex items-center justify-center">
                <span className="text-teal-600 dark:text-teal-300 font-medium">1</span>
              </div>
              <div className="ml-4">
                <h4 className="text-md font-medium text-gray-900 dark:text-white">Configurar API no Abmix</h4>
