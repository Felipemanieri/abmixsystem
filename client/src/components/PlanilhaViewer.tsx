...
export default function PlanilhaViewer() {
  ...
  const formatarDados = () => {
    return proposals.map((proposal: any) => {
      ...
      titulares.forEach((titular: any, index: number) => {
        const prefix = `TITULAR${index + 1}_`;
        Object.assign(linhaBase, {
          [`${prefix}NOME`]: titular.nomeCompleto || '[vazio]',
          ...
          [`${prefix}ENDERECO`]: titular.enderecoCompleto || '[vazio]',
      ...
      dependentes.forEach((dependente: any, index: number) => {
        const prefix = `DEPENDENTE${index + 1}_`;
        Object.assign(linhaBase, {
          [`${prefix}NOME`]: dependente.nomeCompleto || '[vazio]',
