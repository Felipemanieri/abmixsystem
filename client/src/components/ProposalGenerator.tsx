          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700">
            ...
            <div className="flex flex-wrap items-center gap-2 mt-6">
              <button
                ...
                className="flex items-center px-4 py-2.5 bg-gray-600 text-white rounded-md hover:bg-gray-700 transition-colors font-medium shadow-md text-sm"
              >
              ...
              <button
                ...
                className="flex items-center px-4 py-2.5 bg-green-600 text-white rounded-md hover:bg-green-700 transition-colors font-medium shadow-md text-sm"
              >
              ...
              <button
                ...
                className="flex items-center px-4 py-2.5 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors font-medium shadow-md text-sm"
              >
              ...
              <button
                ...
                className="flex items-center px-4 py-2.5 bg-purple-600 text-white rounded-md hover:bg-purple-700 transition-colors font-medium shadow-md text-sm"
              >
              ...
              <button
                ...
                className="flex items-center px-4 py-2.5 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors font-medium shadow-md text-sm ml-auto"
              >
                <Plus className="w-4 h-4 mr-2" />
                Adicionar Cotação
              </button>
                  ...
                  <div key={cotacao.id} className="bg-gray-50 dark:bg-gray-900 p-5 rounded-lg border border-gray-200 dark:border-gray-700 relative">
                    ...
                    <div className="flex justify-end space-x-3 pt-3 border-t border-gray-200 dark:border-gray-700">
                      <button
                        ...
                        className="flex items-center px-4 py-2 bg-green-600 dark:bg-green-600 text-white dark:text-white rounded-md hover:bg-green-700 dark:hover:bg-green-700 transition-colors text-sm font-medium"
                      >
