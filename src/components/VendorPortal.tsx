...
import { LogOut, Plus, Users, FileText, Link, Eye, BarChart3, Clock, CheckCircle, AlertCircle, Copy, ExternalLink, Mail, Download, Search, Filter, ArrowLeft, Home, MessageCircle, Bot, X, Send, Bell, Calculator, Target, TrendingUp } from 'lucide-react';
